...
// Any of the following values are considered true: "true", "True", "TRUE", "T", "t", "1", "yes", "Yes", "YES", "on", "On", "ON"
// Any of the following values are considered false: "false", "False", "FALSE", "F", "f", "0", "no", "No", "NO",  "off", "Off", "OFF"
